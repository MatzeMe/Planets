...
"test NoTest": function(queue) {  //2Routen, weil Routen Einbahnstrassen sein können
	...
	var TestUniverse =[new Planet(10, 300, 100, 0), new Planet(15, 600, 200, 1), new Planet(10, 150, 250, 2), new Planet(20, 500, 350, 3)];
	...
	TestGC.Universe[2].addGroup(Group1); 
	TestGC.Universe[0].addGroup(Group2); 
	TestGC.Universe[0].addGroup(Group3); 
	TestGC.Universe[0].addGroup(Group4); 
	
	console.log("schiffe");
	console.log(TestGC.Universe[0].presentGroups);
